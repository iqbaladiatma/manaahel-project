...
- [ ] 2. Implement database schema and models
  - [ ] 2.1 Create users table migration with role, batch_year, and location fields
  ...
  - [ ] 2.4 Create articles table migration with translatable fields
  ...
  - [ ] 2.5 Create galleries table migration
...
- [ ] 3. Implement Eloquent models with relationships
  ...
  - [ ] 3.2 Create Program model with translatable support
    - Implement HasTranslations trait
  ...
  - [ ] 3.4 Create Article model with translatable support
    - Implement HasTranslations trait
  ...
  - [ ] 3.5 Create Gallery model with visibility logic
    - Define fillable fields
    - Add scopes: visibleForUser(), public(), memberOnly()
    - Add method: isVisibleTo()
    - _Requirements: 7.1, 7.2, 7.3, 7.4_
  
  - [ ] 3.6 Create Course model with translatable support
    - Implement HasTranslations trait
    - Define translatable fields: title, content
  ...
  - [ ] 3.7 Create Category model
    - Implement HasTranslations trait
    - Define translatable fields: name
    - Add relationships: articles()
    - _Requirements: 5.2, 5.4_

- [ ] 4. Implement localization system
  - [ ] 4.1 Create SetLocale middleware
  ...
  - [ ] 4.2 Create LocalizationService
  ...
  - [ ] 4.4 Write property test for RTL/LTR layout switching
    - **Property 2: Non-Arabic languages use LTR layout**
    - **Validates: Requirements 1.3**
  
  - [ ] 4.5 Create language switcher component
...
- [ ] 5. Implement authentication system
  - [ ] 5.1 Setup Laravel Breeze or Fortify for authentication scaffolding
    - Configure email verification
    - Setup password reset functionality
    - _Requirements: 10.1, 10.2, 10.3, 10.4, 10.5_
  
  - [ ] 5.2 Create custom registration controller
    - Validate registration input
    - Create user with role 'user'
    - Send email verification
    - _Requirements: 10.1, 10.2_
  
  - [ ] 5.3 Create custom login controller
  ...
  - [ ] 5.4 Write property test for user registration
    - **Property 35: User registration creates account with default role**
    - **Validates: Requirements 10.1**
  
  - [ ] 5.5 Write property test for email verification
  ...
  - [ ] 5.7 Write property test for invalid login rejection
    - **Property 39: Invalid login rejection**
    - **Validates: Requirements 10.5**

- [ ] 6. Implement authorization with policies
  - [ ] 6.1 Create RegistrationPolicy
...
- [ ] 8. Implement program management module
  - [ ] 8.1 Create ProgramController for public views
  ...
  - [ ] 8.3 Create program detail view
  ...
  - [ ] 8.4 Write property test for active programs visibility
    - **Property 4: Active programs visibility**
    - **Validates: Requirements 2.1**
  
  - [ ] 8.5 Write property test for program details in selected language
    - **Property 5: Program details in selected language**
    - **Validates: Requirements 2.2**
  
  - [ ] 8.6 Write property test for closed program indication
    - **Property 6: Closed program indication**
    - **Validates: Requirements 2.3**

- [ ] 9. Implement registration workflow
  - [ ] 9.1 Create RegistrationController
  ...
  - [ ] 9.2 Create registration form with file upload
...
- [ ] 12. Implement member distribution map
  ...
  - [ ] 12.4 Write property test for members with coordinates appearing on map
    - **Property 19: Members with coordinates appear on map**
    - **Validates: Requirements 6.1**
  
  - [ ] 12.5 Write property test for coordinate updates reflecting on map
...
- [ ] 14. Implement gallery system
  - [ ] 14.1 Create GalleryController
  ...
  - [ ] 14.2 Create gallery index view
  ...
  - [ ] 14.3 Implement gallery visibility logic in model
    - Create isVisibleTo() method checking visibility and batch
    - Create visibleForUser() scope
    - _Requirements: 7.1, 7.3, 7.4_
  
  - [ ] 14.4 Add robots meta tag to prevent search engine indexing
    - Add noindex meta tag to member-only gallery pages
    - _Requirements: 7.5_
  
  - [ ] 14.5 Write property test for batch-filtered gallery visibility
    - **Property 22: Batch-filtered gallery visibility**
    - **Validates: Requirements 7.1**
  
  - [ ] 14.6 Write property test for unauthenticated access redirect
    - **Property 23: Unauthenticated access to member-only gallery redirects**
    - **Validates: Requirements 7.2**
  
  - [ ] 14.7 Write property test for public gallery visibility
    - **Property 24: Public gallery visibility**
    - **Validates: Requirements 7.3**
  
  - [ ] 14.8 Write property test for member-only gallery authentication
    - **Property 25: Member-only gallery requires authentication**
    - **Validates: Requirements 7.4**

- [ ] 15. Implement e-learning system
  - [ ] 15.1 Create CourseController
