<x-app-layout>
    ...
    <div class="relative bg-gradient-to-br from-white via-blue-50 dark:from-dark-bg dark:via-dark-card to-amber-50 py-16 sm:py-20 md:py-24 mt-16 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center">
                ...
                <p class="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed px-4">
    ...
    <div class="py-12 sm:py-16 md:py-20 bg-white dark:bg-dark-card">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="group relative bg-white dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border overflow-hidden hover:border-blue-500 transition-all duration-300 shadow-lg dark:shadow-dark-border hover:shadow-2xl dark:hover:shadow-gold/20">
                            ...
                            <div class="relative bg-gradient-to-r from-blue-600 to-blue-700 dark:from-gold-dark dark:to-gold p-6">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    @if($enrollment->program->delivery_type === 'online_zoom')
                                        <div class="w-10 h-10 bg-white/20 dark:bg-dark-card/40 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/20 dark:border-gold/30">
                            ...
                            <div class="relative p-6">
                                ...
                                <div class="space-y-3 mb-6">
                                    @if($enrollment->program->delivery_type === 'online_course')
                                        <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                            <div class="w-8 h-8 bg-blue-50 dark:bg-blue-dark/20 rounded-lg flex items-center justify-center mr-3">
                                    ...
                                    <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                        <div class="w-8 h-8 bg-amber-50 dark:bg-amber-900/20 rounded-lg flex items-center justify-center mr-3">
                                ...
                                <a href="{{ route('enrolled.show', $enrollment->program->slug) }}" 
                                   class="group/btn relative block w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-xl text-center transition-all duration-300 shadow-lg dark:shadow-dark-border hover:shadow-xl dark:hover:shadow-gold/20 overflow-hidden">
            ...
            @else
                <!-- Empty State -->
                <div class="group relative bg-white dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border overflow-hidden p-12 text-center shadow-lg dark:shadow-dark-border">
                    <!-- Decorative Elements -->
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3">{{ __('No Enrolled Programs Yet') }}</h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto leading-relaxed">{{ __('You haven\'t enrolled in any programs yet. Browse available programs and start learning!') }}</p>
                        <a href="{{ route('programs.index') }}" 
                           class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg dark:shadow-dark-border hover:shadow-2xl dark:hover:shadow-gold/20 transform hover:-translate-y-0.5">
                            {{ __('Browse Programs') }}
