<x-app-layout>
    <div class="min-h-screen bg-gradient-to-br from-green-50 via-white to-gold/5 flex items-center justify-center py-12 px-4">
        <div class="max-w-2xl w-full">
            ...
            <div class="bg-white dark:bg-dark-card rounded-xl shadow-lg dark:shadow-dark-border p-8 mb-6 border-t-4 border-gold">
                ...
                @if($registration->whatsapp_group_link)
                    <!-- WhatsApp Group Link -->
                    <div class="bg-green-50 dark:bg-green-900/20 border-2 border-green-200 rounded-xl p-6 mb-6">
                        <div class="flex items-start mb-4">
                            <svg class="w-6 h-6 text-green-600 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <a href="{{ $registration->whatsapp_group_link }}" 
                                   target="_blank"
                                   class="inline-flex items-center bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg dark:shadow-dark-border">
                ...
                <!-- Info Box -->
                <div class="bg-blue-50 dark:bg-blue-dark/20 border border-blue-200 rounded-xl p-4 mb-6">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('academy.index') }}" 
                       class="flex-1 text-center bg-gray-200 hover:bg-gray-300 text-gray-800 dark:text-gray-200 font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105">
                        Lihat Program Lain
                    </a>
                    <a href="{{ route('home') }}" 
