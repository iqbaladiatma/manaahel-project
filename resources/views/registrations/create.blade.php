<x-app-layout>
    <div class="py-12 mt-20">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg border-2 border-gray-100 p-8">
                @if(session('error'))
                ...
                <form method="POST" action="{{ route('registrations.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <select id="program_id" name="program_id" required
                                class="w-full rounded-lg border-2 border-gray-200 focus:border-blue-primary focus:ring-2 focus:ring-blue-100 transition-all">
                    ...
                    <div class="mb-6">
                        <label for="notes" class="block text-sm font-semibold text-gray-700 mb-2">
                            {{ __('Additional Notes') }} <span class="text-gray-500">({{ __('Optional') }})</span>
                        </label>
                        <textarea id="notes" 
                                  name="notes" 
                                  rows="4"
                    ...
                    <!-- Info Box -->
                    <div class="mb-6 bg-blue-50 border-l-4 border-blue-primary p-4 rounded-r-lg">
                        <div class="flex items-start">
                            <svg class="w-5 h-5 text-blue-primary mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" 
                                class="gradient-blue text-white px-8 py-3 rounded-full font-semibold hover:shadow-xl transition-all duration-300 transform hover:scale-105">
