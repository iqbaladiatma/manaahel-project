<x-app-layout>
    <!-- Hero Section -->
    <div class="relative bg-gradient-to-br from-blue-50 via-white to-gold dark:from-dark-bg dark:via-dark-card dark:to-dark-bg/5 pt-32 pb-12 overflow-hidden">
        <!-- Decorative Elements -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p class="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto animate-slide-up">
    ...
    <div class="pb-16 bg-gray-50 dark:bg-dark-bg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Search and Filter -->
            <div class="bg-white dark:bg-dark-card rounded-2xl shadow-lg dark:shadow-dark-border border-2 border-gray-100 dark:border-dark-border p-8 mb-8 -mt-8 relative z-10">
                <form method="GET" action="{{ route('courses.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <!-- Program Filter -->
                    <div>
                        <label for="program" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                            {{ __('Program') }}
                        </label>
                        <select name="program" 
                                id="program"
                            ...
                            <div class="gradient-blue p-6 relative overflow-hidden">
                                ...
                                <div class="relative z-10">
                                    <div class="flex items-center justify-between mb-3">
                                        <span class="inline-block px-3 py-1 bg-white/20 dark:bg-dark-card/40 backdrop-blur-sm text-white text-xs font-semibold rounded-full border border-white/20 dark:border-gold/30">
                                            {{ $course->program->name }}
                                        </span>
                                        <div class="w-10 h-10 bg-white/20 dark:bg-dark-card/40 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/20 dark:border-gold/30">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-dark-border">
                                    <div class="flex items-center text-sm text-gray-500 dark:text-gray-500">
                                        <svg class="w-4 h-4 mr-1 text-blue-primary dark:text-gold" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"/>
                                        </svg>
                                        {{ __('Order') }}: {{ $course->order }}
                                    </div>
                                    <a href="{{ route('courses.show', $course) }}" 
                                       class="inline-flex items-center text-blue-primary dark:text-gold font-semibold hover:gap-2 transition-all">
                                        {{ __('View Course') }}
            ...
            @else
                <div class="bg-white dark:bg-dark-card rounded-2xl shadow-lg dark:shadow-dark-border border-2 border-gray-100 dark:border-dark-border p-12 text-center">
