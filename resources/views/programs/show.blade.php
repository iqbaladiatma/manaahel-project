        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-4 sm:mb-6">
                <a href="{{ route('programs.index') }}" 
                   class="inline-flex items-center text-blue-primary dark:text-gold hover:text-blue-primary dark:text-gold:text-emerald-300 transition-colors text-sm sm:text-base">
                ...
                <div class="p-4 sm:p-6 md:p-8">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="px-3 py-1 rounded-full text-xs font-medium {{ $program->type === 'academy' ? 'bg-blue-50 dark:bg-blue-dark/20 text-blue-700' : 'bg-purple-50 text-purple-700' }}">
                                {{ ucfirst($program->type) }}
                            </span>
                            
                            @if($program->status)
                                <span class="flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-50 dark:bg-blue-dark/20 text-blue-primary dark:text-gold">
                                    <span class="w-2 h-2 bg-blue-light rounded-full mr-2"></span>
                                    {{ __('Registration Open') }}
                                </span>
                            @else
                                <span class="px-3 py-1 rounded-full text-xs font-medium bg-gray-100 dark:bg-dark-card text-gray-600 dark:text-gray-400">
                    ...
                    <!-- Delivery Type -->
                    <div class="mb-8">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">{{ __('Delivery Method') }}</h3>
                    ...
                    @if($program->syllabus)
                        <div class="mb-8">
                            ...
                            <div class="prose max-w-none text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-dark-bg rounded-lg p-6 border border-gray-200 dark:border-dark-border">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-4">
                                @foreach($program->courses as $courseIndex => $course)
                                    <div class="border border-gray-200 dark:border-dark-border rounded-lg overflow-hidden hover:border-blue-300 transition">
                                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4">
                                            <h4 class="font-bold text-gray-900 dark:text-gray-100 flex items-center">
                                            ...
                                            @if($course->description)
                                                <p class="text-gray-600 dark:text-gray-400 text-sm mt-2 ml-10">{{ $course->description }}</p>
                                            @endif
                                        </div>
                                        @if($course->modules->count() > 0)
                                            <div class="divide-y divide-gray-200">
                                                @foreach($course->modules as $module)
                                                    <div class="px-4 py-3 hover:bg-blue-50 dark:bg-blue-dark/20/50 transition flex items-center justify-between">
                                                        <div class="flex items-center flex-1">
                                                            ...
                                                            <span class="text-gray-700 dark:text-gray-300">{{ $module->title }}</span>
                                                        </div>
                                                        @if($module->duration_minutes)
                                                            <span class="text-sm text-gray-500 dark:text-gray-500 ml-4">{{ $module->duration_minutes }} {{ __('min') }}</span>
                                                        @endif
                                                    </div>
                                                @endforeach
                                            </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-3">
                                @foreach($program->schedules as $schedule)
                                    <div class="flex items-start border border-gray-200 dark:border-dark-border rounded-lg p-4 hover:border-blue-300 hover:bg-blue-50 dark:bg-blue-dark/20/30 transition">
                                        ...
                                        <div class="flex-1">
                                            <h4 class="font-semibold text-gray-900 dark:text-gray-100">{{ $schedule->title }}</h4>
                                            @if($schedule->description)
                                                <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">{{ $schedule->description }}</p>
                                            @endif
                    ...
                    @if($program->status)
                        <div class="border-t border-gray-200 dark:border-dark-border pt-8">
                            @if(isset($isEnrolled) && $isEnrolled)
                                <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 rounded-lg p-6">
                                    ...
                                    <a href="{{ route('enrolled.show', $program->slug) }}" 
                                       class="inline-flex items-center px-8 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition-colors shadow-lg dark:shadow-dark-border hover:shadow-xl dark:hover:shadow-gold/20 transform hover:-translate-y-0.5">
                            ...
                            @else
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">{{ __('Register for this Program') }}</h3>
                                ...
                                @else
                                    <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 rounded-lg p-6">
                                        ...
                                        <div class="flex gap-3">
                                            ...
                                            <a href="{{ route('register') }}" 
                                               class="inline-flex items-center px-6 py-3 bg-gray-900 text-white font-medium rounded-lg hover:bg-gray-800:bg-gray-100 dark:bg-dark-card transition-colors">
                                                {{ __('Register Account') }}
                                            </a>
                                        </div>
                                    </div>
                    ...
                    @else
                        <div class="border-t border-gray-200 dark:border-dark-border pt-8">
                            <div class="bg-gray-50 dark:bg-dark-bg border border-gray-200 dark:border-dark-border rounded-lg p-6">
