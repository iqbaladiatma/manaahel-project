    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden lg:flex lg:ml-10 space-x-1">
                    @auth
                    <!-- Member Navigation -->
                    <a href="{{ route('dashboard') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-gold hover:bg-blue-50 dark:hover:bg-dark-card rounded-lg transition-all duration-200">
                        Dashboard
                    </a>

                    <!-- Program Menu - DISABLED -->
                    <!-- 
                    <a href="{{ route('programs.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-gold hover:bg-blue-50 dark:hover:bg-dark-card rounded-lg transition-all duration-200">
                        Program
                    </a>
                    -->
                    <a href="{{ route('academy.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-gold hover:bg-blue-50 dark:hover:bg-dark-card rounded-lg transition-all duration-200">
                        Academy
                    </a>
                    <a href="{{ route('members.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-gold hover:bg-blue-50 dark:hover:bg-dark-card rounded-lg transition-all duration-200">
                        Anggota
                    </a>
                    <a href="{{ route('gallery.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-gold hover:bg-blue-50 dark:hover:bg-dark-card rounded-lg transition-all duration-200">
                        Galeri
                    </a>
                    <a href="{{ route('articles.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-gold hover:bg-blue-50 dark:hover:bg-dark-card rounded-lg transition-all duration-200">
                        Artikel
                    </a>
                    @else
                    <!-- Public Navigation -->
                    <a href="{{ route('home') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-gold hover:bg-blue-50 dark:hover:bg-dark-card rounded-lg transition-all duration-200">
                        Beranda
                    </a>
                    <a href="{{ route('about') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-gold hover:bg-blue-50 dark:hover:bg-dark-card rounded-lg transition-all duration-200">
                        Tentang
                    </a>
                    ...
                    <a href="{{ route('map.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-gold hover:bg-blue-50 dark:hover:bg-dark-card rounded-lg transition-all duration-200">
                        Peta
                    </a>
                    @endauth
                </div>
            ...
            <!-- Right Side: Dark Mode Toggle & User Actions (Desktop) / Hamburger (Mobile) -->
            <div class="flex items-center space-x-3">
                <!-- Desktop: Dark Mode Toggle & User Actions -->
                <div class="hidden lg:flex lg:items-center lg:space-x-3">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 rounded-lg hover:bg-gray-100 dark:hover:bg-dark-card transition-all duration-200">
                    ...
                    @else
                    <!-- Guest Actions -->
                    <a href="{{ route('login') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-gold transition-colors duration-200">
                        Masuk
                    </a>
                    <a href="{{ route('register') }}" class="gradient-gold text-white px-6 py-2.5 rounded-full text-sm font-medium hover:opacity-90 transition shadow-md">
                        Daftar
                    </a>
                    @endauth
                </div>
                ...
                <button @click="open = true" class="lg:hidden p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-dark-card transition-all duration-200">
